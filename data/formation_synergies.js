...
const FORMATION_SYNERGIES = {
  ...
  // Grail. A Zombie opens a vein for the Vampire beside it, every round, and
  // pays for it out of its own body — the horde keeps the bloodline standing.
  //
