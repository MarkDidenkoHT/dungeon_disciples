const UNIT_ABILITIES = {
  ...
  'divided_flame 1': {
    ...
    type: 'passive',
    trigger: 'on_battle_start',
    description: 'Splits 18 bonus damage evenly among all Demon allies — the fewer you field, the stronger each burns.',
    description_ru: "Делит 18 бонусного урона поровну между всеми союзниками-демонами — чем их меньше, тем сильнее горит каждый.",
    params: { shared_pool_stat: 'damage', shared_pool_value: 18, tag_required: 'Demon' },
  ...
  'divided_flame 2': {
    ...
    type: 'passive',
    trigger: 'on_battle_start',
    description: 'Splits 24 bonus damage evenly among all Demon allies — the fewer you field, the stronger each burns.',
    description_ru: "Делит 24 бонусного урона поровну между всеми союзниками-демонами — чем их меньше, тем сильнее горит каждый.",
    params: { shared_pool_stat: 'damage', shared_pool_value: 24, tag_required: 'Demon' },
    effect_name: 'divided_flame',
  },
  'clear_mind 1': {
    id: 'clear_mind 1',
  ...
  'sole_artificer 1': {
    ...
    type: 'passive',
    trigger: 'on_battle_start',
    description: 'While this is your only Engineer, every Knight ally reduces afflictions applied to them by 1.',
    description_ru: "Пока это ваш единственный инженер, все союзники-рыцари снижают накладываемые на них недуги на 1.",
  ...
  'sole_artificer 2': {
    ...
    type: 'passive',
    trigger: 'on_battle_start',
    description: 'While this is your only Engineer, every Knight ally reduces afflictions applied to them by 2.',
    description_ru: "Пока это ваш единственный инженер, все союзники-рыцари снижают накладываемые на них недуги на 2.",
