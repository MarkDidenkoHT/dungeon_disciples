...
const UNITS = {
  choir_of_the_cursed: {
    ...
    malachite_gargoyle: {
      ...
      action: 'attack', target_type: 'enemy', targets: 6, range: 3,
      damage_source: 'physical', action_power: 18, action_icon: 'throw_stone.jpg', action_animation: 'stone_throw',
  ...
  empire: {
    ...
    mechanic: {
      ...
      xp: 480, passive: ['fortify 1', 'scavenger 1'], ability: 'reforge 1',
    },
    master_mechanic: {
      id: 'e611', f: 'e', t: 3,
      ...
      xp: 1300, passive: ['fortify 2', 'scavenger 1'], ability: 'reforge 2',
    },
    grand_machinist: {
      id: 'e6111', f: 'e', t: 4,
  ...
  grail_of_sorrow: {
    ...
    blood_knight: {
      ...
      xp: 1300, passive: ['lifesteal 1', 'leech 1', 'banquet 1'], ability: 'exsanguinate 1',
    },
    necromancer: {
      id: 'gs32', f: 'g', t: 2,
      name: 'Necromancer',
  ...
  enemies: {
    crimson_basilica: {
      ...
      aggrails_devoted: {
        ...
        tags: ['Demon', 'Holy'],
        size: 'tile',
        hp: 50, armor: 15, initiative: 35,
        resistances: { air: 5, fire: 10, life: 40, death: 15, cold: 5, nature: 10 },
        action: 'attack', target_type: 'enemy', targets: 1, range: 1,
        damage_source: 'physical', action_power: 12, action_icon: 'aggrails_blessing.jpg', action_animation: 'sword_swing',
