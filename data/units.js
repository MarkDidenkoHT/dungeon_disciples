...
const UNITS = {
  ...
  grail_of_sorrow: {
    ...
    necromancer: {
      ...
      action: 'heal', target_type: 'ally', targets: 1, range: 6,
      damage_source: null, action_power: 25,
      xp: 520, passive: 'vitality 1', ability: 'raise_dead 1',
    },
    plague_scholar: {
      id: 'gs33', f: 'g', t: 2,
      name: 'Plague Scholar',
    ...
    husk_colossus: {
      ...
      tags: ['Zombie'],
      size: 'row',
      hp: 120, armor: 0, initiative: 30,
      resistances: { air: 0, fire: 0, life: 0, death: 50, cold: 0, nature: 0 },
      action: 'attack', target_type: 'enemy', targets: 1, range: 1,
      damage_source: 'physical', action_power: 30,
      xp: 300, passive: 'thorns 1', ability: null,
    },
    grail_seraph: {
      id: 'gs41', f: 'g', t: 2,
      name: 'Grail Seraph',
  ...
  enemies: {
    crimson_basilica: {
      aggrails_herald: {
        ...
        xp: 60, passive: 'vitality 1', ability: 'lions_roar 1',
      },
      exalted_herald: {
        ...
        xp: 60, passive: ['vitality 1', 'beacon_of_hope 1'], ability: 'lions_roar 1',
      },
      crimson_archer: {
        id: 'opb_e2', f: 'opb', t: 1,
        name: 'Crimson Archer', //some impure hunter, hunting the impure
        tags: ['Archer', 'Holy'],
        size: 'tile',
        hp: 45, armor: 0, initiative: 65,
      ...
      aggrails_devoted: {
        ...
        resistances: { air: 0, fire: 10, life: 50, death: 15, cold: 0, nature: 0 },
        action: 'attack', target_type: 'enemy', targets: 1, range: 1,
        damage_source: 'physical', action_power: 20,
      ...
      scarlet_fanatic: {
        ...
        resistances: { air: 0, fire: 0, life: 50, death: 0, cold: 0, nature: 20 },
        action: 'attack', target_type: 'enemy', targets: 1, range: 1,
        damage_source: null, action_power: 20,
      ...
      scarlet_agressor: {
        ...
        tags: ['Demon', 'Holy'],
        size: 'tile',
        hp: 75, armor: 15, initiative: 60,
        resistances: { air: 0, fire: 0, life: 50, death: 0, cold: 0, nature: 20 },
        action: 'attack', target_type: 'enemy', targets: 1, range: 1,
        damage_source: null, action_power: 20,
        xp: 260, passive: ['rage 2', 'fanaticism 1', 'shatter 1'], ability: null,
      },
    },
