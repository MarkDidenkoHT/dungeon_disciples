  ...
  enemies: {
    forests_of_ashenveil: {
      bramble_hound: {
        ...
        resistances: { air: 0, fire: -5, life: 10, death: 0, cold: 0, nature: 15 },
        action: 'attack', target_type: 'enemy', targets: 1, range: 1,
      ...
      forest_troll: {
        ...
        resistances: { air: 0, fire: -10, life: 15, death: 0, cold: 0, nature: 20 },
        action: 'attack', target_type: 'enemy', targets: 1, range: 1,
        damage_source: 'physical', action_power: 22,
      ...
      vine_witch: {
        ...
        resistances: { air: 0, fire: -10, life: 15, death: 0, cold: 0, nature: 25 },
      ...
      grove_warden: {
        ...
        resistances: { air: 0, fire: -10, life: 20, death: 0, cold: 0, nature: 20 },
        action: 'heal', target_type: 'ally', targets: 1, range: 3,
      ...
      spore_shaman: {
        ...
        resistances: { air: 0, fire: -10, life: 20, death: 0, cold: 0, nature: 35 },
        action: 'attack', target_type: 'enemy', targets: 3, range: 3,
    ...
    mountains_of_valdrek: {
      ...
      frost_shaman: {
        ...
        resistances: { air: 10, fire: -15, life: 0, death: 0, cold: 30, nature: 0 },
        action: 'attack', target_type: 'enemy', targets: 3, range: 3,
      ...
      glacier_brute: {
        ...
        resistances: { air: 10, fire: -20, life: 0, death: 0, cold: 35, nature: 0 },
        action: 'attack', target_type: 'enemy', targets: 1, range: 1,
      ...
      rune_caster: {
        ...
        resistances: { air: 15, fire: -10, life: 0, death: 0, cold: 25, nature: 0 },
        action: 'attack', target_type: 'enemy', targets: 3, range: 3,
        damage_source: 'air', action_power: 29,
        xp: 430, passive: 'wither 1', ability: null,
      },
      peak_titan: {
        id: 'mv_e8', f: 'mv', t: 4,
        name: 'Peak Titan',
      ...
      storm_witch: {
        ...
        resistances: { air: 30, fire: -10, life: 0, death: 0, cold: 25, nature: 0 },
        action: 'attack', target_type: 'enemy', targets: 3, range: 3,
    ...
    dungeons_of_malgrath: {
      ...
      crypt_shambler: {
        ...
        resistances: { air: 0, fire: -5, life: -15, death: 35, cold: 0, nature: 0 },
        action: 'attack', target_type: 'enemy', targets: 1, range: 1,
      ...
      bone_knight: {
        ...
        resistances: { air: 0, fire: -5, life: -20, death: 45, cold: 0, nature: 0 },
        action: 'attack', target_type: 'enemy', targets: 1, range: 1,
        damage_source: 'physical', action_power: 23,
      ...
      tomb_colossus: {
        ...
        resistances: { air: 0, fire: -10, life: -25, death: 50, cold: 0, nature: 0 },
        action: 'attack', target_type: 'enemy', targets: 1, range: 1,
      ...
      soul_harvester: {
        ...
        resistances: { air: 0, fire: 0, life: -25, death: 55, cold: 0, nature: 0 },
        action: 'attack', target_type: 'enemy', targets: 3, range: 3,
      ...
      malgrath_the_undying: {
        ...
        resistances: { air: 0, fire: -10, life: -30, death: 60, cold: 0, nature: 0 },
        action: 'attack', target_type: 'enemy', targets: 1, range: 1,
