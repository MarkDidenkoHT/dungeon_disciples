...
const UNITS = {
  choir_of_the_cursed: {
    ...
    choir_regent_path_b_t3: {
      ...
      action: 'attack', target_type: 'enemy', targets: 1, range: 3,
      damage_source: 'fire', action_power: 20, action_icon: 'fire_bolt.jpg', action_animation: 'fire_bolt',
      passive: ['divided_flame 1', 'sovereigns_levy 2'], ability: null,
      building_slot: 'slot_0', xp: 1300
    },
    ...
    doomchanter: {
      ...
      resistances: { air: 0, fire: 50, life: 0, death: 20, cold: 0, nature: 0 },
      ...
      xp: 5600, passive: ['rage 2', 'decay 1', 'infect 2'], ability: 'pact 1',
    },
    ash_acolyte: {
      id: 'd2', f: 'd', t: 1,
      name: 'Ash Acolyte',
    ...
    onyx_gargoyle: {
      ...
      xp: 2600, passive: ['unbreakable 1', 'aegis 1', 'resist_aura_death 2'], ability: 'stone_form 2',
    },
    obsidian_gargoyle: {
      id: 'd3111', f: 'd', t: 4,
      ...
      xp: 5600, passive: ['unbreakable 2', 'aegis 1', 'resist_aura_death 2'], ability: 'stone_form 2',
    },
    quartz_gargoyle: {
      id: 'd32', f: 'd', t: 2,
    ...
    azurite_gargoyle: {
      ...
      xp: 2600, passive: ['unbreakable 2', 'aegis 1', 'resist_aura_cold 1'], ability: 'stone_form 2',
    },
    malachite_gargoyle: {
      id: 'd3211', f: 'd', t: 4,
      ...
      action: 'attack', target_type: 'enemy', targets: 6, range: 3,
      damage_source: 'nature', action_power: 18, action_icon: 'throw_stone.jpg', action_animation: 'stone_throw',
      xp: 5600, passive: ['unbreakable 2', 'aegis 1', 'resist_aura_cold 2'], ability: 'stone_form 2',
    },
    alabaster_gargoyle: {
      id: 'd3212', f: 'd', t: 4,
      ...
      xp: 5600, passive: ['unbreakable 2', 'aegis 1', 'resist_aura_life 2'], ability: 'stone_form 2',
    },
    heretic: {
      id: 'd4', f: 'd', t: 1,
      name: 'Heretic',
    ...
    nether_lord: {
      ...
      action: 'attack', target_type: 'enemy', targets: 1, range: 3,
      damage_source: 'fire', action_power: 20, action_icon: 'fire_bolt.jpg', action_animation: 'fire_bolt',
      xp: 1300, passive: ['magic_attunement 1', 'resist_aura_fire 2', 'sovereigns_levy 1'], ability: 'infernal_mandate 3',
    },
    nether_sovereign: {
      id: 'd6111', f: 'd', t: 4,
  ...
  empire: {
    ...
    blade_master: {
      ...
      xp: 2800, passive: ['execute 2', 'iron_will 1', 'parry 1'], ability: 'lions_roar 2',
    },
    horseman: {
      id: 'e12', f: 'e', t: 2,
      name: 'Horseman',
    ...
    cavalry: {
      ...
      xp: 2600, passive: ['impale 2', 'iron_will 1', 'pierce 1'], ability: null,
    },
    standart_bearer: {
      id: 'e13', f: 'e', t: 2,
    ...
    siege_dreadnought: {
      ...
      xp: 2600, passive: ['unbreakable 2', 'shatter 2'], ability: null,  
    },
    smith: {
      id: 'e6', f: 'e', t: 1,
      name: 'Smith',
  ...
  grail_of_sorrow: {
    ...
    grail_seraph: {
      ...
      xp: 960, passive: ['infect 1', 'poison 1', 'horde 1'], ability: 'raise_dead 2',
    },
    grail_angel: {
      id: 'gs411', f: 'g', t: 3,
      name: 'Grail Angel',
      ...
      xp: 2600, passive: ['infect 1', 'poison 2', 'horde 1'], ability: 'raise_dead 2',
    },
    sorrow_bearer: {
      id: 'gs42', f: 'g', t: 2,
      name: 'Sorrow Bearer',
    ...
    grail_keeper: {
      ...
      xp: 1300, passive: ['communion 1', 'resist_aura_fire 1', 'inspiration_damage 1'], ability: 'blood_craze 2',
    },
    grieving_servant: {
      id: 'gs52', f: 'g', t: 2,
  ...
  enemies: {
    ...
    glittering_abyss: {
      ...
      frostshard: {
        ...
        xp: 130, passive: 'chill 1', ability: 'permafrost 1',
      },
      rime_splinter: {
        id: 'mv_e21', f: 'mv', t: 2,
        name: 'Rime Splinter',
        ...
        xp: 540, passive: ['chill 1', 'hungering_frost 1'], ability: 'permafrost 1',
      },
      glacial_prism: {
        id: 'mv_e211', f: 'mv', t: 3,
        name: 'Glacial Prism',
        ...
        xp: 1300, passive: ['chill 1', 'hungering_frost 2'], ability: 'permafrost 1',
      },
      chillrock: {
        id: 'mv_e3', f: 'mv', t: 1,
        name: 'Chillrock',
      ...
      rimewarden: {
        ...
        xp: 1080, passive: ['resist_aura_cold 2', 'rimeguard 1'], ability: null,
      },
      glaciok: {
        id: 'mv_e311', f: 'mv', t: 3,
        name: 'Glaciok',
        ...
        xp: 2600, passive: ['resist_aura_cold 2', 'rimeguard 2'], ability: null,
      },
      cryodrox: {
        id: 'mv_e4', f: 'mv', t: 2,
        name: 'Cryodrox',
    ...
    chamber_of_unrest: {
      ...
      wailing_ghost: {
        ...
        xp: 100, passive: 'chill 1', ability: null,
      },
      revenant: {
        id: 'dm_e31', f: 'dm', t: 2,
        name: 'Revenant',
        ...
        resistances: { air: 0, fire: 0, life: 0, death: 50, cold: 20, nature: 0 },
        action: 'attack', target_type: 'enemy', targets: 6, range: 3,
        damage_source: 'cold', action_power: 9, action_icon: 'haunt.jpg', action_animation: 'frost_bolt', action_sfx: 'haunt',
        xp: 348, passive: ['chill 1', 'sorrow 1'], ability: null,
      },
      soul_harvester: {
        id: 'dm_e311', f: 'dm', t: 3,
        name: 'Soul Harvester',
        ...
        resistances: { air: 0, fire: 0, life: 0, death: 50, cold: 20, nature: 0 },
        action: 'attack', target_type: 'enemy', targets: 6, range: 3,
        damage_source: 'cold', action_power: 12, action_icon: 'haunt.jpg', action_animation: 'frost_bolt', action_sfx: 'haunt',
        xp: 715, passive: ['chill 2', 'sorrow 1'], ability: null,
      },
