...
const UNITS = {
  ...
  empire: {
    ...
    crossbowman: {
      ...
      xp: 1000, passive: ['pierce 2', 'impale 1'], ability: null,
    },
    heavy_infantry: {
      id: 'e112', f: 'e', t: 3,
      name: 'Heavy Infantry',
      ...
      xp: 1000, passive: ['impale 1', 'protector 1', 'iron_will 1'], ability: 'stun 1',
    },
    horseman: {
      id: 'e12', f: 'e', t: 2,
      name: 'Horseman',
  ...
  enemies: {
    crimson_basilica: {
      ...
      high_keeper: {
        ...
        action: 'heal', target_type: 'ally', targets: 1, range: 3,
        damage_source: null, action_power: 16, action_icon: 'holy_heal.jpg', action_animation: 'holy_heal', action_sfx: 'holy_heal',
        xp: 1000, passive: 'vitality 2', ability: 'infernal_mandate 1',
      },
      grand_keeper: {
        ...
        tags: ['Caster', 'Holy'],
        size: 'tile',
        hp: 75, armor: 5, initiative: 25,
        resistances: { air: 5, fire: 20, life: 50, death: 20, cold: 5, nature: 5 },
        action: 'heal', target_type: 'ally', targets: 1, range: 3,
        damage_source: null, action_power: 24, action_icon: 'holy_heal.jpg', action_animation: 'holy_heal', action_sfx: 'holy_heal',
