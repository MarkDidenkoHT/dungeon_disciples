const SPELLS = {
  empire: [
    ...
    },
    {
      ...
      name_ru: 'Аватар света',
      rank: 4,
      tier: 4,
      type: 'preparation',
      description: 'Channel divine power into one ally. Grant +30% damage and +20 armor for the battle.',
      description_ru: 'Наполняет союзника божественной силой. Даёт +30% урона и +20 брони на бой.',
  ...
  choir_of_the_cursed: [
    ...
    },
    {
      ...
      name_ru: 'Проклятое возвышение',
      rank: 4,
      tier: 4,
      type: 'preparation',
      description: 'Ascend your forces with dark power. Grant all allies +25% damage for the battle.',
      description_ru: 'Возвышает ваши войска тёмной силой. Все союзники получают +25% урона на бой.',
  ...
  grail_of_sorrow: [
    ...
    },
    {
      ...
      name_ru: 'Вознесение Грааля',
      rank: 4,
      tier: 4,
      type: 'preparation',
      description: "Channel the grail's power into one ally. Grant +35% lifesteal and +20 armor for the battle.",
      description_ru: 'Вливает силу Грааля в союзника. Даёт +35% вампиризма и +20 брони на бой.',
