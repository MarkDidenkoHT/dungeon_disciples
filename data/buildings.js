...
const BUILDING_POOLS = {
  empire: {
    ...
    barracks: [
      ...
      { id: 'banneret_hall',       label: 'Banneret Hall', label_ru: 'Зал баннеретов',       category: 'barracks', tier: 3, unit_id: 'e131', upgrades: ['gonfalonier_hall'],       cost: { gold: 200 } },
      { id: 'gonfalonier_hall',    label: 'Gonfalonier Hall', label_ru: 'Зал гонфалоньеров', category: 'barracks', tier: 4, unit_id: 'e1311', upgrades: [],                      cost: { gold: 400 } },
      ...
      { id: 'crossbow_range',      label: 'Crossbow Range', label_ru: 'Стрельбище арбалетчиков',      category: 'barracks', tier: 3, unit_id: 'e111', upgrades: ['sniper_nest'],           cost: { gold: 200 } },
      { id: 'sniper_nest',         label: 'Sniper Nest', label_ru: 'Гнездо снайперов',         category: 'barracks', tier: 4, unit_id: 'e1111', upgrades: [],                      cost: { gold: 400 } },
      { id: 'heavy_barracks',      label: 'Heavy Barracks', label_ru: 'Тяжёлые казармы',      category: 'barracks', tier: 3, unit_id: 'e112', upgrades: ['vindicator_barracks'],   cost: { gold: 200 } },
      { id: 'vindicator_barracks', label: 'Vindicator Barracks', label_ru: 'Казармы поборников', category: 'barracks', tier: 4, unit_id: 'e1121', upgrades: [],                     cost: { gold: 400 } },
      ...
      { id: 'knights_stables', label: 'Knights Stables', label_ru: 'Рыцарские конюшни', category: 'barracks', tier: 3, unit_id: 'e121', upgrades: ['retributor_stables'] },
      { id: 'retributor_stables', label: 'Retributor Stables', label_ru: 'Конюшни воздаятелей', category: 'barracks', tier: 4, unit_id: 'e1211', upgrades: [], cost: { gold: 400 } },
      ...
      { id: 'golden_lion_lab', label: 'Golden Lion Lab', label_ru: 'Лаборатория золотых львов', category: 'barracks', tier: 3, unit_id: 'e311', upgrades: ['golden_lion_den'] },
      { id: 'golden_lion_den', label: 'Golden Lion Prime Den', label_ru: 'Логово Золотого Льва Прайм', category: 'barracks', tier: 4, unit_id: 'e3111', upgrades: [] },
      ...
      { id: 'siege_dreadnought_workshop', label: 'Siege Dreadnought Workshop', label_ru: 'Мастерская осадных дредноутов', category: 'barracks', tier: 3, unit_id: 'e321', upgrades: ['dreadnought_foundry'] },
      { id: 'dreadnought_foundry', label: 'Siege Leviathan Foundry', label_ru: 'Литейная Левиафанов', category: 'barracks', tier: 4, unit_id: 'e3211', upgrades: [] },
      ...
      { id: 'mechanic_den_2',      label: 'Mechanic Den II', label_ru: 'Мастерская механиков II',     category: 'barracks', tier: 3, unit_id: 'e611', upgrades: ['machinist_hall', 'armsmaster_hall'], cost: { gold: 200 } },
      ...
      { id: 'devastator_post',     label: 'Devastator Post', label_ru: 'Пост разрушителей',     category: 'barracks', tier: 3, unit_id: 'e621', upgrades: ['devastator_battery'],                        cost: { gold: 200 } },
      { id: 'devastator_battery', label: 'Annihilator Battery', label_ru: 'Батарея Аннигиляторов', category: 'barracks', tier: 4, unit_id: 'e6211', upgrades: [] },
      { id: 'flamethrower_post',   label: 'Flamethrower Post', label_ru: 'Пост огнемётчиков',   category: 'barracks', tier: 3, unit_id: 'e622', upgrades: ['flamethrower_foundry'],                        cost: { gold: 200 } },
      { id: 'flamethrower_foundry', label: 'Inferno Gunner Foundry', label_ru: 'Литейная Огнемётчиков Инферно', category: 'barracks', tier: 4, unit_id: 'e6221', upgrades: [] },
      ...
      { id: 'priest_shrine',       label: 'Priest Shrine', label_ru: 'Святилище жрецов',       category: 'barracks', tier: 2, unit_id: 'e22',  upgrades: ['ardent_shrine', 'seraphic_shrine'], cost: { gold: 100 } },
      ...
      { id: 'seraphic_shrine',     label: 'Seraphic Shrine', label_ru: 'Серафическое святилище', category: 'barracks', tier: 3, unit_id: 'e222',  upgrades: ['seraph_shrine'],     cost: { gold: 200 } },
      { id: 'seraph_shrine',       label: 'Seraph Shrine', label_ru: 'Святилище серафимов',    category: 'barracks', tier: 4, unit_id: 'e2221', upgrades: [],                    cost: { gold: 400 } },
      ...
      { id: 'mithrails_will_temple', label: 'Mithrails Will Temple', label_ru: 'Храм Воли Митраила', category: 'barracks', tier: 3, unit_id: 'e711', upgrades: ['mithrails_verdict_temple'], cost: { gold: 200 } },
      { id: 'mithrails_verdict_temple', label: 'Mithrails Verdict Temple', label_ru: 'Храм приговора Митраила', category: 'barracks', tier: 4, unit_id: 'e7111', upgrades: [] },
      ...
      { id: 'ash_sanctum',         label: 'Ash Sanctum', label_ru: 'Пепельный санктум',         category: 'barracks', tier: 3, unit_id: 'e411', upgrades: ['ash_priest_sanctum'],                        cost: { gold: 200 } },
      { id: 'ash_priest_sanctum', label: 'Ash Hierophant Sanctum', label_ru: 'Святилище Пепельных Иерофантов', category: 'barracks', tier: 4, unit_id: 'e4111', upgrades: [] },
      { id: 'cinder_forge',        label: 'Cinder Forge', label_ru: 'Кузня углей',        category: 'barracks', tier: 3, unit_id: 'e412', upgrades: ['dragon_knight_forge'],                        cost: { gold: 200 } },
      { id: 'dragon_knight_forge', label: 'Dragon Knight Forge', label_ru: 'Кузня драконьих рыцарей', category: 'barracks', tier: 4, unit_id: 'e4121', upgrades: [] },
    ...
    hall_up: [
      ...
      { id: 'infirmary', label: 'Infirmary', label_ru: 'Лазарет', category: 'hall_up', unit_id: null, tier: 1, upgrades: [],
        art: 'infirmary',
        desc: 'Wounded units recover between battles. Each level speeds it up. From level 2 it brews a Health Potion daily, two at level 3.',
        desc_ru: 'Раненые бойцы восстанавливаются между боями. Каждый уровень ускоряет это. С уровня 2 производит Зелье Здоровья каждый день, на уровне 3 — два.',
    ...
    merc_up: [
      ...
      { id: 'transmute_lab', label: 'Transmutation Lab', label_ru: 'Лаборатория трансмутации', category: 'merc_up', unit_id: null, tier: 1, upgrades: [],
        art: 'transmute_lab',
        desc: 'Turns two crystals into a third.',
        desc_ru: 'Превращает два кристалла в третий.',
        cost: { Crystals_Life: 10 } },
    ...
    barracks_up: [
      { id: 'garrison_annex', label: 'Garrison Annex', label_ru: 'Гарнизонная пристройка', category: 'barracks_up', unit_id: null, tier: 1, upgrades: [],
        ...
        cost: { gold: 150, Crystals_Life: 50 },
        upgrade_costs: { 2: { gold: 320, Crystals_Life: 110 }, 3: { gold: 560, Crystals_Life: 190 } } },
      { id: 'proving_grounds', label: 'Proving Grounds', label_ru: 'Ристалище', category: 'barracks_up', unit_id: null, tier: 1, upgrades: [],
        ...
        upgrade_costs: { 2: { gold: 500, Crystals_Life: 160 } } },
  ...
  choir_of_the_cursed: {
    ...
    barracks: [
      ...
      { id: 'praetor_pit',       label: 'Praetor Pit', label_ru: 'Яма преторов',       category: 'barracks', tier: 3, unit_id: 'd111', upgrades: ['conqueror_pit'],             cost: { gold: 200 } },
      { id: 'conqueror_pit', label: 'Conqueror Pit', label_ru: 'Яма завоевателей', category: 'barracks', tier: 4, unit_id: 'd1111', upgrades: [] },
      ...
      { id: 'pyre_watch', label: 'Pyre Watch', label_ru: 'Дозор костра', category: 'barracks', tier: 3, unit_id: 'd211', upgrades: ['ashen_warden_watch', 'pyre_choir_hall'], cost: { gold: 200 } },
      { id: 'pyre_choir_hall', label: 'Pyre Choir Hall', label_ru: 'Зал погребального хора', category: 'barracks', tier: 4, unit_id: 'd2112', upgrades: [] },
      { id: 'ashen_warden_watch', label: 'Ashen Warden Watch', label_ru: 'Дозор пепельных стражей', category: 'barracks', tier: 4, unit_id: 'd2111', upgrades: [] },
      ...
      { id: 'onyx_gargoyle_den',  label: 'Onyx Gargoyle Den', label_ru: 'Логово ониксовых горгулий',  category: 'barracks', tier: 3, unit_id: 'd311', upgrades: ['obsidian_gargoyle_den'], cost: { gold: 200 } },
      { id: 'obsidian_gargoyle_den', label: 'Obsidian Gargoyle Den', label_ru: 'Логово обсидиановых горгулий', category: 'barracks', tier: 4, unit_id: 'd3111', upgrades: [], cost: { gold: 400 } },
      ...
      { id: 'azurite_gargoyle_den', label: 'Azurite Gargoyle Den', label_ru: 'Логово азуритовых горгулий', category: 'barracks', tier: 3, unit_id: 'd321', upgrades: ['malachite_gargoyle_den', 'alabaster_gargoyle_den'], cost: { gold: 200 } },
      { id: 'malachite_gargoyle_den', label: 'Malachite Gargoyle Den', label_ru: 'Логово малахитовых горгулий', category: 'barracks', tier: 4, unit_id: 'd3211', upgrades: [], cost: { gold: 400 } },
      { id: 'alabaster_gargoyle_den', label: 'Alabaster Gargoyle Den', label_ru: 'Логово алебастровых горгулий', category: 'barracks', tier: 4, unit_id: 'd3212', upgrades: [], cost: { gold: 400 } },
      ...
      { id: 'vessel_altar',      label: 'Vessel Altar', label_ru: 'Алтарь сосудов',      category: 'barracks', tier: 3, unit_id: 'd411', upgrades: ['broken_vessel_altar'],             cost: { gold: 200 } },
      { id: 'broken_vessel_altar', label: 'Broken Vessel Altar', label_ru: 'Алтарь сломленных сосудов', category: 'barracks', tier: 4, unit_id: 'd4111', upgrades: [] },
      { id: 'pain_projector_den', label: 'Pain Projector Den', label_ru: 'Логово проводников боли', category: 'barracks', tier: 3, unit_id: 'd412', upgrades: ['agony_engine_den'],           cost: { gold: 200 } },
      { id: 'agony_engine_den', label: 'Agony Engine Den', label_ru: 'Логово машин агонии', category: 'barracks', tier: 4, unit_id: 'd4121', upgrades: [] },
      ...
      { id: 'inferno_spawn_pit', label: 'Inferno Spawn Pit', label_ru: 'Яма порождений инферно', category: 'barracks', tier: 3, unit_id: 'd711', upgrades: ['inferno_scion_crucible'] },
      { id: 'inferno_scion_crucible', label: 'Inferno Scion Crucible', label_ru: 'Горнило отпрысков инферно', category: 'barracks', tier: 4, unit_id: 'd7111', upgrades: [] },
    ...
    barracks_up: [
      { id: 'garrison_annex', label: 'Garrison Annex', label_ru: 'Гарнизонная пристройка', category: 'barracks_up', unit_id: null, tier: 1, upgrades: [],
        ...
        desc_ru: 'Открывает по одному слоту бойца за уровень.',
        cost: { gold: 150, Crystals_Fire: 50 },
        upgrade_costs: { 2: { gold: 320, Crystals_Fire: 110 }, 3: { gold: 560, Crystals_Fire: 190 } } },
      { id: 'proving_grounds', label: 'Proving Grounds', label_ru: 'Ристалище', category: 'barracks_up', unit_id: null, tier: 1, upgrades: [],
        art: 'proving_grounds',
        desc: 'Raises the tier your units may reach: level 1 allows tier 3, level 2 allows tier 4.',
        desc_ru: 'Повышает предельный ранг бойцов: 1 уровень — ранг 3, 2 уровень — ранг 4.',
        cost: { gold: 200, Crystals_Fire: 60 },
        upgrade_costs: { 2: { gold: 500, Crystals_Fire: 160 } } },
      { id: 'training_grounds', label: 'Training Grounds', label_ru: 'Тренировочный двор', category: 'barracks_up', unit_id: null, tier: 1, upgrades: [],
        art: 'training_grounds',
        desc: 'Every embark pays more XP: +5%, then +10%.',
        desc_ru: 'Каждый поход приносит больше опыта: +5%, затем +10%.',
  ...
  grail_of_sorrow: {
    ...
    barracks: [
      ...
      { id: 'plague_knight_barrow',  label: 'Plague Knight Barrow', label_ru: 'Курган чумных рыцарей',  category: 'barracks', tier: 3, unit_id: 'gs111', upgrades: ['plague_knight_mausoleum'], cost: { gold: 200 } },
      { id: 'plague_knight_mausoleum', label: 'Plague Knight Mausoleum', label_ru: 'Мавзолей чумных рыцарей', category: 'barracks', tier: 4, unit_id: 'gs1111', upgrades: [], cost: { gold: 400 } },
      ...
      { id: 'abomination_vat',       label: 'Abomination Vat', label_ru: 'Чан мерзости',       category: 'barracks', tier: 3, unit_id: 'gs121', upgrades: ['abomination_crucible'],   cost: { gold: 200 } },
      { id: 'abomination_crucible',  label: 'Abomination Crucible', label_ru: 'Горнило мерзости', category: 'barracks', tier: 4, unit_id: 'gs1211', upgrades: [], cost: { gold: 400 } },
      ...
      { id: 'blightwalker_mire',     label: 'Blightwalker Mire', label_ru: 'Топь бродящих в порче',     category: 'barracks', tier: 3, unit_id: 'gs131', upgrades: ['blightwalker_fen'],       cost: { gold: 200 } },
      { id: 'blightwalker_fen',      label: 'Blightwalker Fen', label_ru: 'Трясина бродящих в порче', category: 'barracks', tier: 4, unit_id: 'gs1311', upgrades: [], cost: { gold: 400 } },
      ...
      { id: 'chosen_chapel', label: 'Chosen Chapel', label_ru: 'Часовня избранных', category: 'barracks', tier: 3, unit_id: 'gs211', upgrades: ['anointed_altar', 'consecrated_sanctum'] },
      { id: 'anointed_altar', label: 'Anointed Altar', label_ru: 'Алтарь помазания', category: 'barracks', tier: 4, unit_id: 'gs2111', upgrades: [] },
      { id: 'consecrated_sanctum', label: 'Consecrated Sanctum', label_ru: 'Святилище освящённых', category: 'barracks', tier: 4, unit_id: 'gs2112', upgrades: [] },
      ...
      { id: 'death_lord_crypt', label: 'Death Lord Crypt', label_ru: 'Склеп владык смерти', category: 'barracks', tier: 3, unit_id: 'gs321', upgrades: ['mothers_hand_ossuary'] },
      { id: 'mothers_hand_ossuary', label: "Mother's Hand Ossuary", label_ru: 'Оссуарий Длани Матери', category: 'barracks', tier: 4, unit_id: 'gs3211', upgrades: [], cost: { gold: 400 } },
      ...
      { id: 'grail_keeper_chamber', label: 'Grail Keeper Chamber', label_ru: 'Палата хранителей Грааля', category: 'barracks', tier: 3, unit_id: 'gs511', upgrades: ['grail_custodian_chamber'] },
      { id: 'grail_custodian_chamber', label: 'Grail Custodian Chamber', label_ru: 'Палата блюстителей Грааля', category: 'barracks', tier: 4, unit_id: 'gs5111', upgrades: [] },
    ...
    barracks_up: [
      { id: 'garrison_annex', label: 'Garrison Annex', label_ru: 'Гарнизонная пристройка', category: 'barracks_up', unit_id: null, tier: 1, upgrades: [],
        ...
        desc_ru: 'Открывает по одному слоту бойца за уровень.',
        cost: { gold: 150, Crystals_Death: 50 },
        upgrade_costs: { 2: { gold: 320, Crystals_Death: 110 }, 3: { gold: 560, Crystals_Death: 190 } } },
      { id: 'proving_grounds', label: 'Proving Grounds', label_ru: 'Ристалище', category: 'barracks_up', unit_id: null, tier: 1, upgrades: [],
        art: 'proving_grounds',
        desc: 'Raises the tier your units may reach: level 1 allows tier 3, level 2 allows tier 4.',
        desc_ru: 'Повышает предельный ранг бойцов: 1 уровень — ранг 3, 2 уровень — ранг 4.',
        cost: { gold: 200, Crystals_Death: 60 },
        upgrade_costs: { 2: { gold: 500, Crystals_Death: 160 } } },
      { id: 'training_grounds', label: 'Training Grounds', label_ru: 'Тренировочный двор', category: 'barracks_up', unit_id: null, tier: 1, upgrades: [],
        art: 'training_grounds',
        desc: 'Every embark pays more XP: +5%, then +10%.',
        desc_ru: 'Каждый поход приносит больше опыта: +5%, затем +10%.',
...
const UNIT_UPGRADE_PATHS = {
  empire: {
    e311: [{ unit_id: 'e3111', building_id: 'golden_lion_den', label: 'Golden Lion Prime Den', label_ru: 'Логово Золотого Льва Прайм' }],
    e321: [{ unit_id: 'e3211', building_id: 'dreadnought_foundry', label: 'Siege Leviathan Foundry', label_ru: 'Литейная Левиафанов' }],
    e411: [{ unit_id: 'e4111', building_id: 'ash_priest_sanctum', label: 'Ash Hierophant Sanctum', label_ru: 'Святилище Пепельных Иерофантов' }],
    e621: [{ unit_id: 'e6211', building_id: 'devastator_battery', label: 'Annihilator Battery', label_ru: 'Батарея Аннигиляторов' }],
    e622: [{ unit_id: 'e6221', building_id: 'flamethrower_foundry', label: 'Inferno Gunner Foundry', label_ru: 'Литейная Огнемётчиков Инферно' }],
    e711: [
            { unit_id: 'e7111', building_id: 'mithrails_verdict_temple', label: 'Mithrails Verdict Temple', label_ru: 'Храм приговора Митраила' }],
    e412: [
            { unit_id: 'e4121', building_id: 'dragon_knight_forge', label: 'Dragon Knight Forge', label_ru: 'Кузня драконьих рыцарей' }],
    ...
    e121: [{ unit_id: 'e1211', building_id: 'retributor_stables', label: 'Retributor Stables', label_ru: 'Конюшни воздаятелей' }],
    e131: [{ unit_id: 'e1311', building_id: 'gonfalonier_hall', label: 'Gonfalonier Hall', label_ru: 'Зал гонфалоньеров' }],
    ...
    e111: [{ unit_id: 'e1111', building_id: 'sniper_nest', label: 'Sniper Nest', label_ru: 'Гнездо снайперов' }],
    e112: [{ unit_id: 'e1121', building_id: 'vindicator_barracks', label: 'Vindicator Barracks', label_ru: 'Казармы поборников' }],
    ...
    e611: [{ unit_id: 'e6111', building_id: 'machinist_hall',   label: 'Machinist Hall', label_ru: 'Зал машинистов' },
           { unit_id: 'e6112', building_id: 'armsmaster_hall',  label: 'Armsmaster Hall', label_ru: 'Зал оружейных мастеров' }],
    ...
    e22:  [{ unit_id: 'e221', building_id: 'ardent_shrine',     label: 'Ardent Shrine', label_ru: 'Ревностное святилище' },
           { unit_id: 'e222', building_id: 'seraphic_shrine',   label: 'Seraphic Shrine', label_ru: 'Серафическое святилище' }],
    e221: [{ unit_id: 'e2211', building_id: 'high_priest_shrine', label: 'High Priest Shrine', label_ru: 'Святилище верховных жрецов' }],
    e222: [{ unit_id: 'e2221', building_id: 'seraph_shrine',      label: 'Seraph Shrine', label_ru: 'Святилище серафимов' }],
  ...
  choir_of_the_cursed: {
    d412: [
            { unit_id: 'd4121', building_id: 'agony_engine_den', label: 'Agony Engine Den', label_ru: 'Логово машин агонии' }],
    d411: [
            { unit_id: 'd4111', building_id: 'broken_vessel_altar', label: 'Broken Vessel Altar', label_ru: 'Алтарь сломленных сосудов' }],
    d211: [
            { unit_id: 'd2111', building_id: 'ashen_warden_watch', label: 'Ashen Warden Watch', label_ru: 'Дозор пепельных стражей' },
            { unit_id: 'd2112', building_id: 'pyre_choir_hall', label: 'Pyre Choir Hall', label_ru: 'Зал погребального хора' }],
    d111: [
            { unit_id: 'd1111', building_id: 'conqueror_pit', label: 'Conqueror Pit', label_ru: 'Яма завоевателей' }],
    ...
    d311: [{ unit_id: 'd3111', building_id: 'obsidian_gargoyle_den', label: 'Obsidian Gargoyle Den', label_ru: 'Логово обсидиановых горгулий' }],
    d32: [{ unit_id: 'd321', building_id: 'azurite_gargoyle_den', label: 'Azurite Gargoyle Den', label_ru: 'Логово азуритовых горгулий' }],
    d321: [{ unit_id: 'd3211', building_id: 'malachite_gargoyle_den', label: 'Malachite Gargoyle Den', label_ru: 'Логово малахитовых горгулий' },
           { unit_id: 'd3212', building_id: 'alabaster_gargoyle_den', label: 'Alabaster Gargoyle Den', label_ru: 'Логово алебастровых горгулий' }],
  ...
  grail_of_sorrow: {
    ...
    gs321: [{ unit_id: 'gs3211', building_id: 'mothers_hand_ossuary', label: "Mother's Hand Ossuary", label_ru: 'Оссуарий Длани Матери' }],
    gs111: [{ unit_id: 'gs1111', building_id: 'plague_knight_mausoleum', label: 'Plague Knight Mausoleum', label_ru: 'Мавзолей чумных рыцарей' }],
    gs121: [{ unit_id: 'gs1211', building_id: 'abomination_crucible', label: 'Abomination Crucible', label_ru: 'Горнило мерзости' }],
    gs131: [{ unit_id: 'gs1311', building_id: 'blightwalker_fen', label: 'Blightwalker Fen', label_ru: 'Трясина бродящих в порче' }],
    gs21: [{ unit_id: 'gs211', building_id: 'chosen_chapel', label: 'Chosen Chapel', label_ru: 'Часовня избранных' }],
    gs211: [{ unit_id: 'gs2111', building_id: 'anointed_altar', label: 'Anointed Altar', label_ru: 'Алтарь помазания' },
            { unit_id: 'gs2112', building_id: 'consecrated_sanctum', label: 'Consecrated Sanctum', label_ru: 'Святилище освящённых' }],
    ...
    gs511: [{ unit_id: 'gs5111', building_id: 'grail_custodian_chamber', label: 'Grail Custodian Chamber', label_ru: 'Палата блюстителей Грааля' }],
...
const BUILDING_COSTS = {
  ...
  golden_lion_den:               { gold: 154, Crystals_Life: 77, Crystals_Air: 19, Crystals_Frost: 19 },
  dreadnought_foundry:           { gold: 154, Crystals_Life: 77, Crystals_Fire: 19, Crystals_Air: 19 },
  ash_priest_sanctum:            { gold: 154, Crystals_Fire: 77, Crystals_Life: 19, Crystals_Air: 19 },
  devastator_battery:            { gold: 154, Crystals_Life: 77, Crystals_Fire: 19, Crystals_Air: 19 },
  flamethrower_foundry:          { gold: 154, Crystals_Fire: 77, Crystals_Life: 19, Crystals_Nature: 19 },
  conqueror_pit:                 { gold: 154, Crystals_Fire: 77, Crystals_Death: 19, Crystals_Life: 19 },
  ashen_warden_watch:            { gold: 154, Crystals_Fire: 77, Crystals_Death: 19, Crystals_Air: 19 },
  pyre_choir_hall:               { gold: 154, Crystals_Fire: 77, Crystals_Nature: 19, Crystals_Air: 19 },
  broken_vessel_altar:           { gold: 154, Crystals_Fire: 77, Crystals_Life: 19, Crystals_Death: 19 },
  agony_engine_den:              { gold: 154, Crystals_Fire: 77, Crystals_Nature: 19, Crystals_Life: 19 },
  dragon_knight_forge:           { gold: 154, Crystals_Life: 77, Crystals_Fire: 19, Crystals_Death: 19 },
  mithrails_verdict_temple:      { gold: 154, Crystals_Life: 77, Crystals_Air: 19, Crystals_Frost: 19 },
  inferno_scion_crucible:        { gold: 154, Crystals_Fire: 77, Crystals_Death: 19, Crystals_Air: 19 },
  anointed_altar:                { gold: 154, Crystals_Death: 77, Crystals_Life: 19, Crystals_Frost: 19 },
  consecrated_sanctum:           { gold: 154, Crystals_Death: 77, Crystals_Life: 19, Crystals_Nature: 19 },
  grail_custodian_chamber:       { gold: 154, Crystals_Death: 77, Crystals_Fire: 19, Crystals_Nature: 19 },
  gonfalonier_hall:              { gold: 154, Crystals_Life: 77, Crystals_Air: 19, Crystals_Nature: 19 },
  ...
  golden_lion_lab:               { gold: 96, Crystals_Life: 48, Crystals_Air: 12, Crystals_Frost: 12 },
  siege_workshop:                { gold: 90, Crystals_Life: 45, Crystals_Fire: 12, Crystals_Death: 12 },
  siege_dreadnought_workshop:    { gold: 96, Crystals_Life: 48, Crystals_Fire: 12, Crystals_Air: 12 },
  ...
  machinist_hall:                { gold: 154, Crystals_Life: 77, Crystals_Fire: 19, Crystals_Nature: 19 },
  armsmaster_hall:               { gold: 154, Crystals_Life: 77, Crystals_Fire: 19, Crystals_Frost: 19 },
  ...
  seraphic_shrine:               { gold: 96, Crystals_Life: 48, Crystals_Air: 12, Crystals_Nature: 12 },
  seraph_shrine:                 { gold: 160, Crystals_Life: 80, Crystals_Air: 20, Crystals_Nature: 20 },
  ...
  obsidian_gargoyle_den:         { gold: 230, Crystals_Fire: 115, Crystals_Air: 29, Crystals_Death: 29 },
  malachite_gargoyle_den:        { gold: 230, Crystals_Fire: 115, Crystals_Frost: 29, Crystals_Death: 29 },
  alabaster_gargoyle_den:        { gold: 230, Crystals_Fire: 115, Crystals_Life: 29, Crystals_Frost: 29 },
  ...
  plague_knight_mausoleum:       { gold: 154, Crystals_Death: 77, Crystals_Nature: 19, Crystals_Air: 19 },
  ...
  abomination_crucible:          { gold: 154, Crystals_Death: 77, Crystals_Air: 19, Crystals_Frost: 19 },
  blightwalker_mire:             { gold: 96, Crystals_Death: 48, Crystals_Air: 12, Crystals_Nature: 12 },
  blightwalker_fen:              { gold: 154, Crystals_Death: 77, Crystals_Air: 19, Crystals_Nature: 19 },
  ...
  mothers_hand_ossuary:          { gold: 154, Crystals_Death: 77, Crystals_Life: 19 },
