...
const BUILDING_POOLS = {
  empire: {
    throne: [
      ...
      { id: 'paladin_cathedral_2_a',     label: 'Paladin Cathedral II A',   category: 'throne', unit_id: 'h_e_11',   tier: 2, upgrades: ['paladin_cathedral_3_a', 'paladin_cathedral_3_b'] },
      { id: 'paladin_cathedral_2_b',     label: 'Paladin Cathedral II B',   category: 'throne', unit_id: 'h_e_12',   tier: 2, upgrades: ['paladin_cathedral_3_a', 'paladin_cathedral_3_b'] },
      ...
      { id: 'inquisitor_tower_2_a',      label: 'Inquisitor Tower II A',    category: 'throne', unit_id: 'h_e_2_a2', tier: 2, upgrades: ['inquisitor_tower_3_a', 'inquisitor_tower_3_b'] },
      { id: 'inquisitor_tower_2_b',      label: 'Inquisitor Tower II B',    category: 'throne', unit_id: 'h_e_2_b2', tier: 2, upgrades: ['inquisitor_tower_3_a', 'inquisitor_tower_3_b'] },
      ...
      { id: 'artificer_guild_2_a',       label: 'Artificer Guild II A',     category: 'throne', unit_id: 'h_e_3_a2', tier: 2, upgrades: ['artificer_guild_3_a', 'artificer_guild_3_b'] },
      { id: 'artificer_guild_2_b',       label: 'Artificer Guild II B',     category: 'throne', unit_id: 'h_e_3_b2', tier: 2, upgrades: ['artificer_guild_3_a', 'artificer_guild_3_b'] },
  ...
  choir_of_the_cursed: {
    throne: [
      ...
      { id: 'warlord_keep_2_a',   label: 'Warlord Keep II A', category: 'throne', unit_id: 'h_d_1_a2', tier: 2, upgrades: ['warlord_keep_3_a', 'warlord_keep_3_b'] },
      { id: 'warlord_keep_2_b',   label: 'Warlord Keep II B', category: 'throne', unit_id: 'h_d_1_b2', tier: 2, upgrades: ['warlord_keep_3_a', 'warlord_keep_3_b'] },
      ...
      { id: 'hexblade_sanctum_2_a',   label: 'Hexblade Sanctum II A', category: 'throne', unit_id: 'h_d_2_a2', tier: 2, upgrades: ['hexblade_sanctum_3_a', 'hexblade_sanctum_3_b'] },
      { id: 'hexblade_sanctum_2_b',   label: 'Hexblade Sanctum II B', category: 'throne', unit_id: 'h_d_2_b2', tier: 2, upgrades: ['hexblade_sanctum_3_a', 'hexblade_sanctum_3_b'] },
      ...
      { id: 'infernal_spire_2_a',   label: 'Infernal Spire II A', category: 'throne', unit_id: 'h_d_3_a2', tier: 2, upgrades: ['infernal_spire_3_a', 'infernal_spire_3_b'] },
      { id: 'infernal_spire_2_b',   label: 'Infernal Spire II B', category: 'throne', unit_id: 'h_d_3_b2', tier: 2, upgrades: ['infernal_spire_3_a', 'infernal_spire_3_b'] },
  ...
  grail_of_sorrow: {
    throne: [
      ...
      { id: 'prophet_sepulchre_2_a',   label: 'Prophet Sepulchre II A',  category: 'throne', unit_id: 'h_g_1_a2', tier: 2, upgrades: ['prophet_sepulchre_3_a', 'prophet_sepulchre_3_b'] },
      { id: 'prophet_sepulchre_2_b',   label: 'Prophet Sepulchre II B',  category: 'throne', unit_id: 'h_g_1_b2', tier: 2, upgrades: ['prophet_sepulchre_3_a', 'prophet_sepulchre_3_b'] },
      ...
      { id: 'warden_crypt_2_a',   label: 'Warden Crypt II A',  category: 'throne', unit_id: 'h_g_2_a2', tier: 2, upgrades: ['warden_crypt_3_a', 'warden_crypt_3_b'] },
      { id: 'warden_crypt_2_b',   label: 'Warden Crypt II B',  category: 'throne', unit_id: 'h_g_2_b2', tier: 2, upgrades: ['warden_crypt_3_a', 'warden_crypt_3_b'] },
      ...
      { id: 'voice_chapel_2_a',   label: 'Voice Chapel II A',  category: 'throne', unit_id: 'h_g_3_a2', tier: 2, upgrades: ['voice_chapel_3_a', 'voice_chapel_3_b'] },
      { id: 'voice_chapel_2_b',   label: 'Voice Chapel II B',  category: 'throne', unit_id: 'h_g_3_b2', tier: 2, upgrades: ['voice_chapel_3_a', 'voice_chapel_3_b'] },
