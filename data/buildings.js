...
const BUILDING_POOLS = {
  empire: {
    ...
    barracks: [
      ...
      { id: 'golden_forge',        label: 'Golden Forge',        category: 'barracks', tier: 1, unit_id: 'e5',   upgrades: ['e51'],                   cost: { gold: 150 } },
      ...
      { id: 'blessed_soul_shrine', label: 'Blessed Soul Shrine', category: 'barracks', tier: 1, unit_id: 'e7',   upgrades: ['e71', 'e72'],            cost: { gold: 50 } },
      { id: 'mithrails_light_temple', label: 'Mithrails Light Temple', category: 'barracks', tier: 2, unit_id: 'e71', upgrades: [], cost: { gold: 100 } },
      { id: 'mithrails_will_temple', label: 'Mithrails Will Temple', category: 'barracks', tier: 3, unit_id: 'e72', upgrades: [], cost: { gold: 200 } },
...
const UNIT_UPGRADE_PATHS = {
  empire: {
    ...
    e7:   [{ unit_id: 'e71',  building_id: 'mithrails_light_temple', label: 'Mithrails Light Temple' },
           { unit_id: 'e72',  building_id: 'mithrails_will_temple',  label: 'Mithrails Will Temple' }],
