...
const BUILDING_POOLS = {
  empire: {
    ...
    barracks: [
      ...
      { id: 'warder_sanctum',      label: 'Warder Sanctum', label_ru: 'Санктум хранителей',      category: 'barracks', tier: 2, unit_id: 'e43',  upgrades: ['bulwark_sanctum'], cost: { gold: 100 } },
  ...
  choir_of_the_cursed: {
    ...
    barracks: [
      ...
      { id: 'gnawling_warren',   label: 'Gnawling Warren', label_ru: 'Нора грызунов',   category: 'barracks', tier: 1, unit_id: 'd2',  upgrades: [], cost: { gold: 50 } },
...
const BUILDING_COSTS = {
  ...
  gnawling_warren:               { gold: 40, Crystals_Fire: 20, Crystals_Air: 5 },
