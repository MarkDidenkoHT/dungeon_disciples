...
const BUILDING_POOLS = {
  empire: {
    throne: [
      ...
      { id: 'ranger_outpost_1',          label: 'Ranger Outpost',           category: 'throne', unit_id: 'h_e_3',    tier: 1, upgrades: ['h_e_3_a2', 'h_e_3_b2'] },
      { id: 'ranger_outpost_2_a',        label: 'Ranger Outpost II A',      category: 'throne', unit_id: 'h_e_3_a2', tier: 2, upgrades: ['h_e_3_a3', 'h_e_3_b3'] },
      { id: 'ranger_outpost_2_b',        label: 'Ranger Outpost II B',      category: 'throne', unit_id: 'h_e_3_b2', tier: 2, upgrades: ['h_e_3_a3', 'h_e_3_b3'] },
      { id: 'ranger_outpost_3_a',        label: 'Ranger Outpost III A',     category: 'throne', unit_id: 'h_e_3_a3', tier: 3, upgrades: ['h_e_3_a41', 'h_e_3_a42'] },
      { id: 'ranger_outpost_3_b',        label: 'Ranger Outpost III B',     category: 'throne', unit_id: 'h_e_3_b3', tier: 3, upgrades: ['h_e_3_b41', 'h_e_3_b42'] },
      { id: 'ranger_outpost_4_a',        label: 'Ranger Outpost IV A',      category: 'throne', unit_id: 'h_e_3_a41', tier: 4, upgrades: [] },
      { id: 'ranger_outpost_4_a_alt',    label: 'Ranger Outpost IV A Alt',  category: 'throne', unit_id: 'h_e_3_a42', tier: 4, upgrades: [] },
      { id: 'ranger_outpost_4_b',        label: 'Ranger Outpost IV B',      category: 'throne', unit_id: 'h_e_3_b41', tier: 4, upgrades: [] },
      { id: 'ranger_outpost_4_b_alt',    label: 'Ranger Outpost IV B Alt',  category: 'throne', unit_id: 'h_e_3_b42', tier: 4, upgrades: [] },
    ],
    barracks: [
      ...
      { id: 'mechanic_den',        label: 'Mechanic Den',        category: 'barracks', tier: 2, unit_id: 'e61',  upgrades: [],                        cost: { gold: 100 } },
      ...
      { id: 'scout_post',          label: 'Scout Post',          category: 'barracks', tier: 1, unit_id: 'e8',   upgrades: ['e81', 'e82'],            cost: { gold: 50 } },
      { id: 'archer_range',        label: 'Archer Range',        category: 'barracks', tier: 2, unit_id: 'e81',  upgrades: [],                        cost: { gold: 100 } },
      { id: 'sniper_nest',         label: 'Sniper Nest',         category: 'barracks', tier: 2, unit_id: 'e82',  upgrades: [],                        cost: { gold: 100 } },
      { id: 'acolyte_shrine',      label: 'Acolyte Shrine',      category: 'barracks', tier: 1, unit_id: 'e2',   upgrades: ['e21', 'e22', 'e23'],     cost: { gold: 50 } },
      { id: 'sun_temple',          label: 'Sun Temple',          category: 'barracks', tier: 2, unit_id: 'e21',  upgrades: [],                        cost: { gold: 100 } },
      ...
      { id: 'purgator_chapel',     label: 'Purgator Chapel',     category: 'barracks', tier: 2, unit_id: 'e23',  upgrades: [],                        cost: { gold: 100 } },
      { id: 'mage_tower',          label: 'Mage Tower',          category: 'barracks', tier: 1, unit_id: 'e4',   upgrades: ['e41'],                   cost: { gold: 50 } },
  ...
  choir_of_the_cursed: {
    ...
    barracks: [
      ...
      { id: 'tormentor_pit',     label: 'Tormentor Pit',     category: 'barracks', tier: 2, unit_id: 'd11', upgrades: [],               cost: { gold: 100 } },
      { id: 'hellblade_forge',   label: 'Hellblade Forge',   category: 'barracks', tier: 2, unit_id: 'd12', upgrades: [],               cost: { gold: 100 } },
      { id: 'gargoyle_roost',    label: 'Gargoyle Roost',    category: 'barracks', tier: 1, unit_id: 'd3',  upgrades: ['d31', 'd32'],   cost: { gold: 50 } },
      { id: 'stone_gargoyle_den', label: 'Stone Gargoyle Den', category: 'barracks', tier: 2, unit_id: 'd31', upgrades: [],              cost: { gold: 100 } },
      { id: 'quartz_gargoyle_den', label: 'Quartz Gargoyle Den', category: 'barracks', tier: 2, unit_id: 'd32', upgrades: [],            cost: { gold: 100 } },
      { id: 'heretic_pit',       label: 'Heretic Pit',       category: 'barracks', tier: 1, unit_id: 'd4',  upgrades: ['d41', 'd42'],   cost: { gold: 50 } },
      { id: 'vessel_altar',      label: 'Vessel Altar',      category: 'barracks', tier: 2, unit_id: 'd41', upgrades: [],               cost: { gold: 100 } },
      { id: 'pain_projector_den', label: 'Pain Projector Den', category: 'barracks', tier: 2, unit_id: 'd42', upgrades: [],             cost: { gold: 100 } },
  ...
  grail_of_sorrow: {
    ...
    barracks: [
      ...
      { id: 'catapult_workshop',     label: 'Catapult Workshop',     category: 'barracks', tier: 1, unit_id: 'gs2',  upgrades: ['gs21', 'gs22'],            cost: { gold: 50 } },
      { id: 'corpse_launcher_shop',  label: 'Corpse Launcher Shop',  category: 'barracks', tier: 2, unit_id: 'gs21', upgrades: [],                          cost: { gold: 100 } },
      { id: 'meat_wagon_butchery',   label: 'Meat Wagon Butchery',   category: 'barracks', tier: 2, unit_id: 'gs22', upgrades: [],                          cost: { gold: 100 } },
...
const UNIT_UPGRADE_PATHS = {
  empire: {
    ...
    e8:   [{ unit_id: 'e81',  building_id: 'archer_range',      label: 'Archer Range' },
    ...
    h_e_3:    [{ unit_id: 'h_e_3_a2', building_id: 'ranger_outpost_2_a', label: 'Ranger Outpost II A' },
               { unit_id: 'h_e_3_b2', building_id: 'ranger_outpost_2_b', label: 'Ranger Outpost II B' }],
    h_e_3_a2: [{ unit_id: 'h_e_3_a3', building_id: 'ranger_outpost_3_a', label: 'Ranger Outpost III A' },
               { unit_id: 'h_e_3_b3', building_id: 'ranger_outpost_3_b', label: 'Ranger Outpost III B' }],
    h_e_3_b2: [{ unit_id: 'h_e_3_a3', building_id: 'ranger_outpost_3_a', label: 'Ranger Outpost III A' },
               { unit_id: 'h_e_3_b3', building_id: 'ranger_outpost_3_b', label: 'Ranger Outpost III B' }],
    h_e_3_a3: [{ unit_id: 'h_e_3_a41', building_id: 'ranger_outpost_4_a',     label: 'Ranger Outpost IV A' },
               { unit_id: 'h_e_3_a42', building_id: 'ranger_outpost_4_a_alt', label: 'Ranger Outpost IV A Alt' }],
    h_e_3_b3: [{ unit_id: 'h_e_3_b41', building_id: 'ranger_outpost_4_b',     label: 'Ranger Outpost IV B' },
               { unit_id: 'h_e_3_b42', building_id: 'ranger_outpost_4_b_alt', label: 'Ranger Outpost IV B Alt' }],
  },

  choir_of_the_cursed: {
    d1:  [{ unit_id: 'd11', building_id: 'tormentor_pit',      label: 'Tormentor Pit' },
          { unit_id: 'd12', building_id: 'hellblade_forge',    label: 'Hellblade Forge' }],
    ...
    d4:  [{ unit_id: 'd41', building_id: 'vessel_altar',       label: 'Vessel Altar' },
          { unit_id: 'd42', building_id: 'pain_projector_den', label: 'Pain Projector Den' }],
  ...
  grail_of_sorrow: {
    ...
    gs2:  [{ unit_id: 'gs21',  building_id: 'corpse_launcher_shop', label: 'Corpse Launcher Shop' },
  ...
  crimson_basilica: [
    {
      ...
      unit_id:  'aggrails_herald',
      tier:     1,
      upgrades: ['cb_exalted_herald', 'cb_aggrails_devoted', 'cb_scarlet_fanatic'],
    ...
    },
    {
      ...
      region:   'crimson_basilica',
      unit_id:  'aggrails_champion',
      tier:     3,
      upgrades: [],
      cost:     { vial_of_pure_blood: 4, aggrails_signet: 3 },
    },
    {
      id:       'cb_scarlet_fanatic',
      label:    'Scarlet Fanatic',
      region:   'crimson_basilica',
      unit_id:  'scarlet_fanatic',
      tier:     2,
      upgrades: ['cb_scarlet_agressor'],
      cost:     { vial_of_pure_blood: 2, aggrails_signet: 2 },
    },
    {
      id:       'cb_scarlet_agressor',
      label:    'Scarlet Agressor',
      region:   'crimson_basilica',
      unit_id:  'scarlet_agressor',
      tier:     3,
      upgrades: [],
      cost:     { vial_of_pure_blood: 4, aggrails_signet: 3 },
    },
    {
      id:       'cb_crimson_archer',
      label:    'Crimson Archer',
      region:   'crimson_basilica',
      unit_id:  'crimson_archer',
      tier:     1,
      upgrades: [],
      cost:     { vial_of_pure_blood: 1, aggrails_signet: 1 },
    },
