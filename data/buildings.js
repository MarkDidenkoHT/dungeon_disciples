...
const BUILDING_POOLS = {
  empire: {
    ...
    barracks: [
      ...
      { id: 'infantry_barracks',   label: 'Infantry Barracks', label_ru: 'Пехотные казармы',   category: 'barracks', tier: 2, unit_id: 'e11',  upgrades: ['crossbow_range', 'heavy_barracks'],         cost: { gold: 100 } },
      ...
      { id: 'mithrails_champion_keep', label: 'Mithrails Champion Keep', label_ru: 'Твердыня поборников Митраила', category: 'barracks', tier: 3, unit_id: 'e211', upgrades: [], cost: { gold: 200 } },
      ...
      { id: 'ardent_shrine',       label: 'Ardent Shrine', label_ru: 'Ревностное святилище',       category: 'barracks', tier: 3, unit_id: 'e221', upgrades: [],                        cost: { gold: 200 } },
      ...
      { id: 'mage_tower',          label: 'Mage Tower', label_ru: 'Башня магов',          category: 'barracks', tier: 1, unit_id: 'e4',   upgrades: ['red_mage_tower', 'blue_mage_tower'],            cost: { gold: 50 } },
  ...
  choir_of_the_cursed: {
    ...
    barracks: [
      ...
      { id: 'chanter_chamber',   label: 'Chanter Chamber', label_ru: 'Палата певчих',   category: 'barracks', tier: 3, unit_id: 'd121', upgrades: [],             cost: { gold: 200 } },
      ...
      { id: 'nether_lord_hall', label: 'Nether Lord Hall', label_ru: 'Зал владык Преисподней', category: 'barracks', tier: 3, unit_id: 'd611', upgrades: [] },
  ...
  grail_of_sorrow: {
    ...
    barracks: [
      ...
      { id: 'plague_lord_lab',       label: 'Plague Lord Lab', label_ru: 'Лаборатория владык чумы',       category: 'barracks', tier: 3, unit_id: 'gs331', upgrades: [] },
      ...
      { id: 'grieving_custodian_chamber', label: 'Grieving Custodian Chamber', label_ru: 'Палата скорбящих блюстителей', category: 'barracks', tier: 3, unit_id: 'gs521', upgrades: [] },
      ...
      { id: 'pale_maiden_barrow',    label: 'Pale Maiden Barrow', label_ru: 'Курган бледных дев',    category: 'barracks', tier: 1, unit_id: 'gs7',   upgrades: ['pale_dame_barrow', 'pale_votaress_chantry'], cost: { gold: 50 } },
