...
const BUILDING_POOLS = {
  empire: {
    throne: [
      ...
      { id: 'paladin_cathedral_1',  label: 'Paladin Cathedral',  category: 'throne', unit_id: 'h_e_1', tier: 1, upgrades: ['h_e_1_t2', 'h_e_1_t3', 'h_e_1_t4'] },
      { id: 'paladin_cathedral_2',  label: 'Paladin Cathedral II',  category: 'throne', unit_id: 'h_e_1_t2', tier: 2, upgrades: ['h_e_1_t3'] },
      { id: 'paladin_cathedral_3',  label: 'Paladin Cathedral III', category: 'throne', unit_id: 'h_e_1_t3', tier: 3, upgrades: ['h_e_1_t4'] },
      { id: 'paladin_cathedral_4',  label: 'Paladin Cathedral IV',  category: 'throne', unit_id: 'h_e_1_t4', tier: 4, upgrades: [] },
    ...
    barracks: [
      ...
      { id: 'workshop',           label: 'Worskshop',          category: 'barracks', tier: 1, unit: 'smith',     unit_id: 'e6', upgrades: ['e61', 'e62'], cost: { gold: 50 } },
      { id: 'workshop',           label: 'Worskshop II',       category: 'barracks', tier: 2, unit: 'mechanic',  unit_id: 'e61', upgrades: [], cost: { gold: 50 } },
      { id: 'workshop',           label: 'Worskshop III',      category: 'barracks', tier: 2, unit: 'rifleman',  unit_id: 'e62', upgrades: [], cost: { gold: 50 } },
...
const UNIT_UPGRADE_PATHS = {
  empire: {
    ...
    h_e_1_t2: [
      { unit_id: 'h_e_1_t3', building_id: 'paladin_cathedral_3', label: 'Paladin Cathedral III' },
    ],
    h_e_1_t3: [
      { unit_id: 'h_e_1_t4', building_id: 'paladin_cathedral_4', label: 'Paladin Cathedral IV' },
    ],
    h_e_2: [
