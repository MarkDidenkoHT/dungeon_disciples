...
const BUILDING_POOLS = {
  empire: {
    ...
    barracks: [
      ...
      { id: 'cavalry_stables',     label: 'Cavalry Stables',     category: 'barracks', tier: 2, unit_id: 'e12',  upgrades: [],                        cost: { gold: 100 } },
      ...
      { id: 'mithrails_light_temple', label: 'Mithrails Light Temple', category: 'barracks', tier: 2, unit_id: 'e71', upgrades: [], cost: { gold: 100 } },
      ...
      { id: 'blue_mage_tower',     label: 'Blue Mage Tower',     category: 'barracks', tier: 2, unit_id: 'e42',  upgrades: [],                        cost: { gold: 100 } },
    ],
    special: [
  ...
  choir_of_the_cursed: {
    ...
    barracks: [
      ...
      { id: 'greater_flame_spawn_pit', label: 'Greater Flame Spawn Pit', category: 'barracks', tier: 2, unit_id: 'd71', upgrades: [], cost: { gold: 100 } },
      { id: 'cultist_shrine',    label: 'Cultist Shrine',    category: 'barracks', tier: 1, unit_id: 'd5',  upgrades: ['d51'],          cost: { gold: 50 } },
      { id: 'choir_servant_shrine', label: 'Choir Servant Shrine', category: 'barracks', tier: 2, unit_id: 'd51', upgrades: [],       cost: { gold: 100 } },
    ],
    special: [
      { id: 'mercenary_hall', label: 'Mercenary Hall', category: 'special', unit_id: null },
    ],
  ...
  grail_of_sorrow: {
    ...
    barracks: [
      ...
      { id: 'crimson_communicant_chapel', label: 'Crimson Communicant Chapel', category: 'barracks', tier: 2, unit_id: 'gs21', upgrades: [], cost: { gold: 100 } },
      ...
      { id: 'necromancer_crypt',     label: 'Necromancer Crypt',     category: 'barracks', tier: 2, unit_id: 'gs32', upgrades: [],                          cost: { gold: 100 } },
      { id: 'plague_scholar_lab',    label: 'Plague Scholar Lab',    category: 'barracks', tier: 2, unit_id: 'gs33', upgrades: [],                          cost: { gold: 100 } },
      { id: 'colossus_barrow',       label: 'Colossus Barrow',       category: 'barracks', tier: 1, unit_id: 'gs4',  upgrades: ['gs41', 'gs42'],            cost: { gold: 50 } },
      { id: 'seraph_shrine',         label: 'Seraph Shrine',         category: 'barracks', tier: 2, unit_id: 'gs41', upgrades: [],                          cost: { gold: 100 } },
      { id: 'chalice_vault',         label: 'Chalice Vault',         category: 'barracks', tier: 2, unit_id: 'gs42', upgrades: [],                          cost: { gold: 100 } },
      ...
      { id: 'grail_tender_chamber',  label: 'Grail Tender Chamber',  category: 'barracks', tier: 2, unit_id: 'gs51', upgrades: [],                          cost: { gold: 100 } },
      { id: 'grieving_servant_chamber', label: 'Grieving Servant Chamber', category: 'barracks', tier: 2, unit_id: 'gs52', upgrades: [], cost: { gold: 100 } },
...
const UNIT_UPGRADE_PATHS = {
  empire: {
    ...
    e7:   [{ unit_id: 'e71',  building_id: 'mithrails_light_temple', label: 'Mithrails Light Temple' },
           { unit_id: 'e711',  building_id: 'mithrails_will_temple',  label: 'Mithrails Will Temple' }],
