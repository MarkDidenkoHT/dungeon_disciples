  ...
  empire: {
    ...
    merc_up: [
      ...
      { id: 'transmute_lab', label: 'Transmutation Lab', label_ru: 'Лаборатория трансмутации', category: 'merc_up', unit_id: null, tier: 1, upgrades: [],
        art: 'transmute_lab',
        desc: 'Opens Transmutation on the Items screen: turn two crystals into a third.',
        desc_ru: 'Открывает трансмутацию на экране предметов: два кристалла превращаются в третий.',
