...
const ITEM_DEFS = {
  ...
  crystal_shield: {
    ...
    tag_required: null,
    adds_tag:     null,
    stat_mods:    { hp: 2, armor: 2, cold_resist: 5 },
    passive:      'unbreakable 1',
    icon:         'crystal_shield',
    rarity:       'epic',
    cost:         { crystal_shard: 1, Gold: 60, Crystals_Frost: 20 },
  ...
  aegis_of_the_first_ward: {
    ...
    rarity:       'mythic',
    unique:       true,
    cost:         { vial_of_pure_blood: 2, shard_of_devotion: 2, Gold: 25, Crystals_Life: 25 },
  ...
  codex_aeternum: {
    ...
    icon:         'codex_aeternum',
    rarity:       'rare',
    cost:         { Gold: 20, Crystals_Life: 20, Crystals_Nature: 20 },
  ...
  codex_militarum: {
    ...
    rarity:       'rare',
    cost:         { Gold: 50, Crystals_Life: 15, Crystals_Air: 10 },
  ...
  court_regalia: {
    ...
    icon:         'court_regalia',
    rarity:       'rare',
    cost:         { vial_of_pure_blood: 1, Gold: 25, Crystals_Fire: 10 },
  ...
  aldras_devotion: {
    ...
    rarity:       'mythic',
    unique:       true,
    cost:         { shard_of_devotion: 10, Gold: 100, Crystals_Life: 50, Crystals_Death: 50 },
    item_cost:    { iron_armor: 1, death_resistance_potion: 1 },
  },
  shroud_of_the_fallen: {
    ...
    rarity:       'epic',
    unique:       true,
    cost:         { grave_dust: 2, Gold: 50, Crystals_Death: 25 },
  ...
  iron_armor: {
    ...
    icon:         'iron_armor',
    rarity:       'rare',
    cost:         { Gold: 60, Crystals_Nature: 10, Crystals_Air: 10 },
    item_cost:    { padded_armor: 1 },
  },
  rimeheart: {
    key:          'rimeheart',
    ...
    tag_required: null,
    adds_tag:     null,
    stat_mods:    { armor: 2, hp: 3, cold_resist: 5 },
    passive:      'rimeguard 1',
    icon:         'rimeheart',
    rarity:       'epic',
    cost:         { Gold: 30, Crystals_Frost: 15 },
    item_cost:    { iron_armor: 1, cold_resistance_potion: 2 },
  },
  everliving_stalk: {
    ...
    rarity:       'epic',
    cost:         { Gold: 120, Crystals_Life: 30, Crystals_Death: 30, Crystals_Nature: 30 },
  },
  ...
  fire_staff: {
    ...
    icon:         'fire_staff',
    rarity:       'epic',
    cost:         { Gold: 70, Crystals_Fire: 30, aggrails_signet: 1 },
  ...
  burning_tyrant: {
    ...
    rarity:       'mythic',
    unique:       true,
    cost:         { Gold: 50, Crystals_Fire: 25, aggrails_signet: 2, grave_dust: 2 },
    item_cost:    { fire_staff: 1 },
  },
  dragon_scale: {
    key:          'dragon_scale',
    name:         "Dragon Scale",
  ...
  iron_sword: {
    ...
    icon:         'iron_sword',
    rarity:       'rare',
    cost:         { Gold: 50, Crystals_Fire: 15, Crystals_Nature: 10 },
    item_cost:    { crude_sword: 1 },
  },
  crystal_sword: {
    key:          'crystal_sword',
    ...
    rarity:       'epic',
    unique:       true,
    cost:         { crystal_shard: 1, Gold: 50, Crystals_Air: 25, Crystals_Frost: 25 },
  ...
  forbidden_vow: {
    ...
    rarity:       'epic',
    unique:       true,
    cost:         { grave_dust: 2, Gold: 30, Crystals_Nature: 20 },
  ...
  burning_fury: {
    ...
    tag_required: 'Demon',
    adds_tag:     null,
    stat_mods:    { action_power: 5 },
    passive:      'rage 1',
    icon:         'burning_fury',
    rarity:       'epic',
    unique:       true,
    cost:         { Gold: 100, Crystals_Air: 15, Crystals_Frost: 15 },
    item_cost:    { iron_sword: 1 },
  },
  mace: {
    key:          'mace',
  ...
  orb_of_pure_blood: {
    ...
    rarity:       'rare',
    unique:       true,
    cost:         { vial_of_pure_blood: 1, Gold: 15, Crystals_Death: 15 },
    item_cost:    { seal_of_power: 1, life_charm: 1 },
  },
  ...
  grovekeeper_staff: {
    ...
    tag_required: null,
    adds_tag:     'Treefolk',
    stat_mods:    { action_power: 1, nature_resist: 5 },
    passive:      null,
    icon:         'grovekeeper_staff',
    rarity:       'rare',
    unique:       true,
    cost:         { vial_of_pure_blood: 1, Gold: 50, Crystals_Nature: 25 },
  ...
  frost_lance: {
    ...
    tag_required: null,
    adds_tag:     null,
    stat_mods:    { action_power: 2, cold_resist: 1 },
    passive:      'chill 1',
    icon:         'frost_lance',
    rarity:       'rare',
    cost:         { crystal_dust: 1, Gold: 45, Crystals_Frost: 25 },
    item_cost:    { seal_of_power: 1 },
  },
  bone_barrier: {
    key:          'bone_barrier',
    ...
    rarity:       'epic',
    unique:       true,
    cost:         { grave_dust: 1, shard_of_might: 1, shard_of_devotion: 1, Gold: 150 },
  ...
  cloak_of_evasion: {
    ...
    rarity:       'common',
    cost:         { Gold: 30, Crystals_Air: 5, Crystals_Nature: 5  },
  },
  travelers_bedroll: {
    ...
    rarity:       'rare',
    unique:       true,
    cost:         { Gold: 50, Crystals_Life: 25, Crystals_Nature: 25 },
  },
  veterans_medal: {
    key:          'veterans_medal',
    ...
    rarity:       'rare',
    unique:       true,
    cost:         { Gold: 50, Crystals_Fire: 25, Crystals_Death: 25 },
  },
  shackle_of_servitude: {
    ...
    rarity:       'rare',
    unique:       true,
    cost:         { Gold: 50, Crystals_Life: 25, Crystals_Death: 25 },
  },
  scavengers_satchel: {
    ...
    rarity:       'rare',
    unique:       true,
    cost:         { Gold: 50, Crystals_Nature: 25, Crystals_Air: 25 },
  },
  attuned_focus: {
    key:          'attuned_focus',
    name:         'Attuned Focus',
    ...
    rarity:       'rare',
    unique:       true,
    cost:         { Gold: 50, Crystals_Air: 25, Crystals_Frost: 25 },
  },
};
