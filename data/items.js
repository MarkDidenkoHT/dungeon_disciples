...
const ITEM_DEFS = {
  ...
  broken_sigil: {
    ...
    tag_required: null,
    adds_tag:     null,
    removes_tag:  'Construct',
    stat_mods:    { hp: 4, armor: 2 },
    passive:      'vow_of_silence 1',
    icon:         'broken_sigil',
    rarity:       'shattered',
    unique:       true,
  ...
  blood_of_a_saint: {
    ...
    adds_tag:     null,
    removes_tag:  'Spirit',
    stat_mods:    { hp: 5, death_resist: 5},
    passive:      'inner_fire 1',
  ...
  clockwork_plate: {
    ...
    rarity:       'mythic',
    unique:       true,
    cost:         { vial_of_pure_blood: 5, crystal_shard: 5, Crystals_Life: 50 },
    item_cost:    { iron_armor: 2, veterans_medal: 1 },
  },
  might_of_the_pure: {
  ...
  sanctified_bulwark: {
    ...
    rarity:       'epic',
    unique:       true,
    cost:         { aggrails_signet: 2, Gold: 50, Crystals_Nature: 10  },
    item_cost:    { iron_armor: 1, orb_of_light: 1 },
  },
  divine_circlet: {
    key:          'divine_circlet',
    name:         'Divine Circlet',
    name_ru:      'Освященная Диадема',
    faction:      null,
    tag_required: null,
    adds_tag:     'Spirit',
    blocked_tags: ['Skeleton', 'Zombie'],
    stat_mods:    { hp: 8 },
    passive:      'pure_blood 1',
    icon:         'divine_circlet',
    rarity:       'epic',
    unique:       true,
    cost:         { aggrails_signet: 2  },
    item_cost:    { orb_of_pure_blood: 1, orb_of_light: 1 },
  },
  sanctified_guardian: {
    ...
    tag_required: null,
    adds_tag:     'Holy',
    blocked_tags: ['Demon', 'Zombie'],
    stat_mods:    { hp: 2, armor: 5 },
    passive:      'protector 2',
    icon:         'sanctified_guardian',
    rarity:       'epic',
    unique:       true,
    cost:         { aggrails_signet: 2, Gold: 90, Crystals_Life: 25, Crystals_Air: 10 },
  ...
  gift_of_eternity: {
    key:          'gift_of_eternity',
    name:         'Gift Of Eternity',
    name_ru:      'Дар Вечности',
    faction:      null,
    tag_required: null,
    adds_tag:     'Vampire',
    stat_mods:    { action_power: 3, hp: 3, armor: 3 },
    passive:      'inspiration_max_hp 1',
    icon:         'gift_of_eternity',
    rarity:       'epic',
    unique:       true,
    cost:         { Gold: 50, Crystals_Life: 10, Crystals_Frost: 10 },
    item_cost:    { codex_aeternum: 1, vampirics_dagger: 1 },
  },
  codex_militarum: {
    key:          'codex_militarum',
  ...
  aldras_patience: {
    key:          'aldras_patience',
    name:         "Aldra's Patience",
    name_ru:      'Терпение Алдры',
    faction:      null,
    tag_required: null,
    adds_tag:     'Demon',
    stat_mods:    { action_power: 5, death_resist: 5},
    passive:      'aggrails_blessing 1',
    icon:         'aldras_patience',
    rarity:       'mythic',
    unique:       true,
    cost:         { shard_of_devotion: 10, Gold: 75, Crystals_Fire: 40, Crystals_Death: 35 },
    item_cost:    { iron_armor: 1, death_resistance_potion: 2 },
  },
  ...
  mothers_gift: {
    ...
    icon:         'mothers_gift',
    rarity:       'rare',
    cost:         { Gold: 50, Crystals_Death: 20, Crystals_Frost: 10, Crystals_Air: 10 },
    requires:     { region: 'any', level: 1 },
  },
  dark_determination: {
    key:          'dark_determination',
    name:         "Dark Determination",
    name_ru:      'Темная Решимость',
    faction:      null,
    tag_required: null,
    adds_tag:     'Zombie',
    ...
    rarity:       'rare',
    unique:       true,
    cost:         { Gold: 50, Crystals_Death: 20, Crystals_Nature: 20 },
    requires:     { region: 'any', level: 1 },
  },
  vampirics_dagger: {
  ...
  arcane_staff: {
    key:          'arcane_staff',
    name:         "Arcane Staff",
    name_ru:      'Чародейский Посох',
    faction:      null,
    tag_required: 'Caster',
    adds_tag:     null,
    stat_mods:    { action_power: 2, hp: 5 },
    passive:      'dissipate 1',
    requires_action: 'damage',
    blocked_tags: ['Engineer', 'Zombie'],
    icon:         'arcane_staff',
    rarity:       'epic',
    unique:       true,
    cost:         { Gold: 50, Crystals_Frost: 10, Crystals_Air: 10, Crystals_Nature: 10, Crystals_Fire: 10, Crystals_Life: 10, Crystals_Death: 10  },
    requires:     { region: 'any', level: 2 },
    item_cost:    { caster_hat: 1 }
  },
  ...
  shard_of_hate: {
    ...
    rarity:       'rare',
    unique:       true,
    cost:         { shard_of_devotion: 1, aggrails_signet:1, Gold: 40, Crystals_Death: 15, Crystals_Fire: 15 },
    item_cost:    {mace: 1},
  },
  hatemace: {
    key:          'hatemace',
    ...
    rarity:       'epic',
    unique:       true,
    cost:         { shard_of_might: 2, aggrails_signet:1, Gold: 40, Crystals_Death: 15, Crystals_Fire: 15 },
    item_cost:    {shard_of_hate: 1, seal_of_power: 1},
  },
  seal_of_power: {
    key:          'seal_of_power',
    name:         "Seal Of Power",
